...
{
    public abstract class SocketHandler_2
    {

        public ConnectManager Connections { get; set; }

        public SocketHandler_2(ConnectManager connections)
        {
        ...
        {
            await SendMessage(Connections.GetSocketById(id).webSocket, message);
        }
        ...
        public async Task SendMessageToAll(string message)
        {
            ...
            {
                await SendMessage(con.webSocket, message);
            }
        }
